...
# Container -----------------------
# date
day_frame = Frame(window,width=50)
day_frame.place(x=160,y=60)
day_label = Label(day_frame,text=':اليوم')
day_label.pack()
day_input = Spinbox(day_frame,from_=1,to=31,width=input_width)
day_input.pack()

month_frame = Frame(window,width=50)
month_frame.place(x=100,y=60)
month_label = Label(month_frame,text=':الشهر')
month_label.pack()
month_input = Spinbox(month_frame,from_=1,to=12,width=input_width)
month_input.pack()

year_frame = Frame(window,width=60)
year_frame.place(x=40,y=60)
year_label = Label(year_frame,text=':السنة')
year_label.pack()
year_input = Spinbox(year_frame,from_=1962,to=2090,width=(input_width * 2))
year_input.pack()
# watchman
